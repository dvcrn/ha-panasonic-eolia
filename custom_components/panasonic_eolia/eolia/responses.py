...
class DeviceStatus:
    def __init__(self, **kwargs):
        ...
        self.operation_status: Optional[bool] = kwargs.get('operation_status')  # false = off, true = on
        ...
        self.operation_priority: Optional[bool] = kwargs.get('operation_priority')  # false = normal
        self.timer_value: Optional[int] = kwargs.get('timer_value')  # Timer in minutes (0 = off)
        self.device_errstatus: Optional[bool] = kwargs.get('device_errstatus')  # false = no error
        self.airquality: Optional[bool] = kwargs.get('airquality')  # Air quality feature on/off
        ...
        self.wind_direction_horizon: Optional[Union[WindDirectionHorizon, str]] = cast(
            ...
            self._parse_enum(kwargs.get('wind_direction_horizon'), WindDirectionHorizon)
        )

        self.operation_token: Optional[str] = kwargs.get('operation_token')

    def _parse_enum(self, value: Optional[str], enum_class) -> Optional[Union[Enum, str]]:
